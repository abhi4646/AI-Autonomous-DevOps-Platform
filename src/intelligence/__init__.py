...
class DecisionContext:
    ...
    def execution_success_rate(
        ...
        None means there is not enough execution history
    ...
    def remediation_success_rate(
        ...
        """
        Historical remediation success rate.

        None means there is no previous remediation history.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        Convert the normalized context into a serializable
        dictionary for audit logs, APIs, and scoring.
        """
    ...
    def from_dict(
        ...
        """
        Restore a DecisionContext from dictionary data.
        """
